          ...
          <div class="card bg-dark text-white" style="border-radius: 15px">
            <div class="card-body p-5">
              <h2 class="text-uppercase text-center mb-5">
                Please Fill the Pet's Information
              </h2>
              ...
              <form @submit.prevent="AddPet">
                ...
                <div class="form-outline mb-4">
                  ...
                  >Pet's Expenses (Value in Dollars)</label
                  >
                  <input
                      id="expenses"
                      v-model="petinfo.Expenses"
                ...
                <div class="form-outline mb-4">
                  <label class="form-label" for="emotion"
                  >How Emotional is your Pet?</label
                  >
                  <input
                      id="emotion"
                      v-model="petinfo.EmotionalNeed"
                      class="form-range"
                      max="10"
                      min="1"
                      name="emotion"
                      step="0.5"
                      type="range"
                  /><span>{{ petinfo.EmotionalNeed }}</span>
                </div>
                <div class="form-outline mb-4">
                  <label class="form-label" for="physical"
                  >How Active is your Pet?</label
                  >
                  <input
                      id="physical"
                      v-model="petinfo.PhysicalActivityNeed"
                      class="form-range"
                      max="10"
                      min="1"
                      name="physical"
                      step="0.5"
                      type="range"
                  /><span>{{ petinfo.PhysicalActivityNeed }}</span>
                </div>
                <div class="form-outline mb-4">
                  <label class="form-label" for="shy"
                  >How Shy is your Pet?</label
                  >
                  <input
                      id="shy"
                      v-model="petinfo.ShynessLevel"
                      class="form-range"
                      max="10"
                      min="1"
                      name="shy"
                      step="0.5"
                      type="range"
                  /><span>{{ petinfo.ShynessLevel }}</span>
                </div>
                <div class="form-outline mb-4">
                  <label class="form-label" for="age"
                  >How Old is Your Pet? (In Months)</label
                  >
                  <input
                      id="age"
                      v-model="petinfo.Age"
...
export default {
  ...
  methods: {
    async AddPet() {
      try {
        await axios.post("placeholder/api/adderanimal/add").then((answer) => {
